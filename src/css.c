...
static const gchar *css_data = 
	...
	".label#data_3 { color: #400080; font-family: Sans; font-size: 7px; }"
	".label#title_1 { font-family: Sans; font-size: 15px; font-weight: bold; }"
	".label#title_2 { font-family: Serif; font-size: 15px; font-style: italic; color: #fa8072; }"
	".label#title_3 { font-family: Sans; font-size: 9px; color: @DARK_BLUE;}"
	".label#title_4 { font-family: Sans; font-size: 9px; font-weight: bold; }"
	".label#title_5 { font-family: Sans; font-size: 9px; color: #e00b40;}"
	".label#status { font-family: Sans; font-size: 9px; color: #b8860b; font-style: italic; }"
	...
	".combobox .entry, .button, .window { color: @METAL_GREY; font-family: Sans; font-size: 9px; }"
	...
	".notebook * { font-family: Sans; font-size: 8px; }"
